...
export function DecorationVelocity({ className, ...props }: React.ComponentProps<"div">) {
  const clipPathId = useId();
  return (
    <div className={cn("flex flex-col items-center gap-2", className)} {...props}>
      <span className="typography-body-bold [writing-mode:sideways-rl]">299 792 458 m / s</span>
      <svg width="17" height="58" viewBox="0 0 17 58" fill="none" xmlns="http://www.w3.org/2000/svg" role="presentation">
        ...
        <defs>
          <clipPath id={clipPathId}>
            <rect width="58" height="17" fill="white" transform="translate(2.53526e-06 58) rotate(-90)" />
          </clipPath>
        </defs>
      </svg>
    </div>
